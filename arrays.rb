...
# The last element "butter" is the answer to what is in the index position 2. 
# "butter" is in index position 2 in the ingredients array but it is the thrid element 
# of our list since the array started with 0 for the first element.
...
# Again, I'm not sure how to show you this in Terminal, but I commented out all except lines 7 and 44-48.
